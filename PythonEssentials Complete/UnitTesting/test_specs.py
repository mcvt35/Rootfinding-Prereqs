...
@pytest.fixture
def setup_bad_sets():
    set_good = ['0123', '1230', '2301', '3012', '0132', '1320', '3201', '2013', '0213', '2130', '1302', '3021']
    set_11_cards = ['0123', '1230', '2301', '3012', '0132', '1320', '3201', '2013', '0213', '2130', '1302']
    set_card_multiples = ['0123', '1230', '2301', '3012', '0132', '1320', '3201', '2013', '0213', '2130', '1302', '0123']
    set_card_3digits = ['0123', '1230', '230', '3012', '0132', '1320', '3201', '2013', '0213', '2130', '1302', '3021']
    set_bad_char = ['0123', '1230', '2301', '3012', '0132', '1320', '3201', '2013', '0213', '2130', '1302', '3024']
...
def test_set_count_sets(setup_bad_sets):
    ...
    with pytest.raises(ValueError) as not4digits2:
        specs.count_sets(['0123', '1230', '2301', '3012', '0132', '1320', '3201', '2013', '0213', '2130', '1302', '30213'])
    ...
    assert specs.count_sets(set_good) == 11
